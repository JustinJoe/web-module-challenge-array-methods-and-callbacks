...
function getYears(fifaArr, getFinalsCb) {
    const years = getFinalsCb(fifaArr).map(match => match.Year)
    return years;
}
...
function getWinners(fifaArr, getFinalsCb) {
    const winners = getFinalsCb(fifaArr).map(match => {
